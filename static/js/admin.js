...
<div class="new-course">
    ...
    <label for="category">دسته‌بندی دوره را انتخاب کنید:</label>
    <select id="category">
        <option value="langs">زبان ها</option>
        <option value="bot">ربات</option>
        <option value="web">وب</option>
        <option value="mobile">موبایل</option>
        <option value="tools">ابزار ها</option>
			...
			"footer": [
				...
				[
					...
					},
					{
						...
						"id": "Done",
						"text": "بررسی",
						"event": `makeCourse(document.getElementById("name").value, document.getElementById("level").value, document.getElementById("price").value, $('option:selected', this).val());`
					}
				]
			]
		}
...
var makeCourse = (name, level, price, category) => {
